...
class CustomRandomExcursionsVariantTestCase(TestCase):
    ...
    def run_random_excursions_variant_test(self, bit_sequence):
        ...
        try:
            ...
            self.assertGreaterEqual(result, 0.01, "❌ NIST Random Excursions Variant Test 실패: 랜덤성이 부족합니다.")
        except ValueError as e:
            print(f"오류 발생: {str(e)}")

    def test_sample_file(self):
        """
        sample_bits.txt 파일에서 비트 시퀀스를 읽어와 Random Excursions Variant Test를 수행합니다.
        """
        try:
...
if __name__ == "__main__":
    ...
    CustomRandomExcursionsVariantTestCase().generate_random_bits_with_crossings(1000000)
    unittest.main()
