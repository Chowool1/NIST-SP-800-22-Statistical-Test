...
class CustomRandomExcursionsTestCase(TestCase):
    ...
    def run_random_excursions_test(self, bit_sequence):
        ...
        - 비트 시퀀스를 입력으로 받아 NIST Random Excursions 테스트 통과 여부를 검증하고 결과 출력.
        """
        # 비트 문자열을 바이트 배열로 변환
        ...
        self.assertGreaterEqual(result, 0.01, "❌ NIST Random Excursions 테스트 실패: 랜덤성이 부족합니다.")
        
        return result

    def test_sample_file(self):
        """
        sample_bits.txt 파일에서 비트 시퀀스를 읽어와 Random Excursions 테스트를 수행합니다.
        """
        try:
    ...
    def generate_random_bits(self, num_bits=1000000, output_file="sample_bits.txt"):
        """
...
if __name__ == "__main__":
    ...
    CustomRandomExcursionsTestCase().generate_random_bits(1000000)
    unittest.main()
